...
Route::group(['middleware' => ['role:user']], function () {
    ...
    Route::get('/validasi/NonValid', 'ValidasiController@listNonValidasi')->name('list-Nonvalid');
...
Route::get('/dataTrb', 'LandingPageController@dataRealisasiTrb')->name('dataTrb');
Auth::routes();
